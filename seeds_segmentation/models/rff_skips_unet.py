...
def unet_rff_skips(input_shape=(128,128,3), name='UNET_RFF', out_channels=1, out_ActFunction='sigmoid',
...
if __name__ == "__main__":
    ...
    model = unet_rff_skips(kernel_regularizer=kernel_regularizer)
