...
def res_unet_rff_skips(input_shape=(128,128,3), name='RES_UNET_RFF_SKIPS', out_channels=1, out_ActFunction='sigmoid',
    ...
    level_1 =  ConvRFF_block(c1, deepth=8, block_id='01',kernel_regularizer=k_r,**kwargs_convRFF)
    ...
    level_2 =  ConvRFF_block(c2, deepth=16, block_id='02',kernel_regularizer=k_r,**kwargs_convRFF)
    ...
    level_3 =  ConvRFF_block(c3, deepth=32, block_id='03',kernel_regularizer=k_r,**kwargs_convRFF)
    ...
    level_4 =  ConvRFF_block(c4, deepth=64, block_id='04',kernel_regularizer=k_r,**kwargs_convRFF)
